  ...
  [HeroType.COMMANDER]: {
    ...
    abilities: [
      COMMON_EDIT_ACTION,
      {
        ...
        effects: [{ type: 'BUFF', buffType: BuffType.ATK_UP, value: 5, duration: 2, target: Target.ALLY_LOWEST_HP }],
      ...
      },
      {
        ...
        effects: [{ type: 'SHIELD', value: 30, target: Target.ALLY_LOWEST_HP }],
        category: AbilityCategory.UNIQUE,
        abilityType: AbilityType.EFFECT,
      },
    ],
  ...
  [HeroType.MAGE]: {
    ...
    abilities: [
      COMMON_EDIT_ACTION,
      {
        ...
        effects: [{ type: 'DAMAGE', value: 2.0, target: Target.ENEMY_ANY }],
        category: AbilityCategory.UNIQUE,
        abilityType: AbilityType.EFFECT,
      },
      {
        ...
        effects: [{ type: 'DEBUFF', buffType: BuffType.ATK_DOWN, value: 5, duration: 2, target: Target.ENEMY_ANY }],
        category: AbilityCategory.UNIQUE,
        abilityType: AbilityType.EFFECT,
      },
    ],
  ...
  [HeroType.SUPPORT]: {
    ...
    abilities: [
      COMMON_EDIT_ACTION,
      {
        ...
        effects: [{ type: 'HEAL', value: 30, target: Target.ALLY_LOWEST_HP }],
        category: AbilityCategory.UNIQUE,
        abilityType: AbilityType.EFFECT,
      },
      {
