...
### §3.2 카드 선택 영역 (중앙)
- 5장 카드를 중앙 기준 평면 카드열로 배치
- 카드열 전체 폭을 기준으로 외곽 좌우 마진이 대칭이 되도록 정렬
- 카드 크기와 간격은 유지하되, 각도나 높이 차이 없이 안정적으로 정렬
